...
public class DomConstants {
    ...
    public static final String BELOW_MINIMUM_AMOUNT_OF_CAPACITIES_MESSAGE = "The bootcamp needs at least %s, capabilities";
    public static final String ABOVE_MINIMUM_AMOUNT_OF_CAPACITIES_MESSAGE = "The bootcamp can not have more than %s, capabilities";
